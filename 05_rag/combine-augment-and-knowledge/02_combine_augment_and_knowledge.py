...
prompt = (
    "You are an AI assistant helping with answering questions from a chunks of content. "
    "Only answer AI related questions, else say you cannot answer."
)

# Combine the prompt with the user's question
prompt = (
    "Read the following information that might contain the context you require to answer the question. You can use the informations starting from the <START_OF_CONTEXT> tag and ending at the <END_OF_CONTEXT> tag. Here is the content:\n\n<START_OF_CONTEXT>\n{}\n<END_OF_CONTEXT>\n\n"
    "Please provide an answer to the following question:\nQuestion: {}\nAnswer:"
)
prompt = prompt.format(top_chunks, QUESTION)
